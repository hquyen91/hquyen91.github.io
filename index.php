...
?>   
                <div class="span9" id="content">
                    <div class="row-fluid quick-actions">
                        ...
                        <div class="span2">
                            <a href="password_strength/index.html" class="quick-action">
                                <span class="icon shield"></span>
                                Kiểm tra Pass
                            </a>
                        </div>
                        <div class="span2">
                            <a href="Password-Generator-AngularJS/index.html" class="quick-action">
                            ...
                            <div class="box">                              
                                ...
                                <div class="box-content nopadding">                                  
                                    <table id="datatable" class="table table-striped table-bordered">
                                      ...
                                      <tbody>              
                                       <?php  
                                         $stmt = $contact->get_user_contact($id=2); //thay đổi $id=1 set admin
